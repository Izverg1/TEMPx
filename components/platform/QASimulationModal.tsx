        ...
        {status === 'idle' && (
             <div className="space-y-4 pt-4">
                <div>
                    ...
                    <select className="w-full mt-1 h-10 bg-brand-bg-light border border-brand-border rounded-md px-3 text-brand-text-light focus:ring-2 focus:ring-brand-cyan">
